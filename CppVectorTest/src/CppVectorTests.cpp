...
/**
 * Test for adding and removing object at the beginning.
 */
...
{
    const int& size = GetParam(); // get param value
    ...
    typename DContainer<int>::DIterator it = container.begin();
    typename DContainer<int>::DIterator end = container.end();

    ASSERT_EQ(size, end - it);
    ...
    typename DContainer<int>::DReverseIterator rit = container.rbegin();
    typename DContainer<int>::DReverseIterator rend = container.rend();

    ASSERT_EQ(size, rend - rit);
    ...
    {
        {
            const typename DContainer<int>::DIterator itToFirstItem = container.begin();
            const typename DContainer<int>::DReverseIterator itToLastItem = container.rbegin();
            const typename DContainer<int>::DIterator calculatedLast = itToFirstItem + (size - 1);
            const typename DContainer<int>::DIterator calculatedFirst = calculatedLast - (size - 1);
        ...
        }
        {
            const typename DContainer<int>::DReverseIterator itToLastItem = container.rbegin();
            const typename DContainer<int>::DIterator itToFirstItem = container.begin();
            const typename DContainer<int>::DReverseIterator calculatedFirst = itToLastItem + (size - 1);
            const typename DContainer<int>::DReverseIterator calculatedLast = calculatedFirst - (size - 1);
