 ...
 */
template<unsigned int TSize>
void vector_pushBack(benchmark::State& aState)
{
...
BENCHMARK_TEMPLATE(vector_pushBack, oneObjectSizeBytes1)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushBack);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushBack, oneObjectSizeBytes4)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushBack);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushBack, oneObjectSizeBytes8)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushBack);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushBack, oneObjectSizeBytes16)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushBack);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushBack, oneObjectSizeBytes512)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushBack);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushBack, oneObjectSizeBytes1024)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushBack);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushBack, oneObjectSizeBytes2048)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushBack);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushBack, oneObjectSizeBytes16384)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushBack);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushBack, oneObjectSizeBytes32768)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushBack);
 ...
 */
template<unsigned int TSize>
void vector_pushFront(benchmark::State& aState)
{
    const int64_t value = aState.range(0);
...
BENCHMARK_TEMPLATE(vector_pushFront, oneObjectSizeBytes1)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushFront);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushFront, oneObjectSizeBytes4)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushFront);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushFront, oneObjectSizeBytes8)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushFront);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushFront, oneObjectSizeBytes16)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushFront);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushFront, oneObjectSizeBytes512)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushFront);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushFront, oneObjectSizeBytes1024)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushFront);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushFront, oneObjectSizeBytes2048)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushFront);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushFront, oneObjectSizeBytes16384)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushFront);

///////////////////////////////////////////////////////////////////

BENCHMARK_TEMPLATE(vector_pushFront, oneObjectSizeBytes32768)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityPushFront);
...
void vector_get(benchmark::State& aState)
{
    const unsigned int size = static_cast<unsigned int>(aState.range(0));
    CContainer<CObject<TSizeObject>> container;
...
BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes1, 100u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet100);

BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes4, 100u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet100);

BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes1024, 100u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet100);

BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes16384, 100u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet100);

/////////////////////////
/////////// 3/4 /////////

BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes1, 75u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet75);

BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes4, 75u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet75);

BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes1024, 75u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet75);

BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes16384, 75u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet75);

/////////////////////////
/////////// 1/2 /////////

BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes1, 50u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet50);

BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes4, 50u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet50);

BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes1024, 50u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet50);

BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes16384, 50u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet50);

/////////////////////////
/////////// 1/4 /////////

BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes1, 25u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet25);

BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes4, 25u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet25);

BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes1024, 25u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet25);

BENCHMARK_TEMPLATE(vector_get, oneObjectSizeBytes16384, 25u)
->RangeMultiplier(rangeMultiplier)->Range(rangeMin, rangeMax)->Complexity(complexityGet25);
